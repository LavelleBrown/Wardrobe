...
namespace Wardrobe.Controllers
{
    public class AccessoriesController : Controller
    {
        ...
        public ActionResult Create([Bind(Include = "AccessoriesID,Name,Color,Occasion,Photo")] Accessory accessory)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public ActionResult Edit([Bind(Include = "AccessoriesID,Name,Color,Occasion,Photo")] Accessory accessory)
        {
            if (ModelState.IsValid)
            {
