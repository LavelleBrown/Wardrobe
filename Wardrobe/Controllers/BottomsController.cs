...
namespace Wardrobe.Controllers
{
    public class BottomsController : Controller
    {
        ...
        public ActionResult Create([Bind(Include = "BottomsID,Name,Color,Season,Occasion,Photo")] Bottom bottom)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public ActionResult Edit([Bind(Include = "BottomsID,Name,Color,Season,Occasion,Photo")] Bottom bottom)
        {
            if (ModelState.IsValid)
            {
