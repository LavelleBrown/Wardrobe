...
namespace Wardrobe.Controllers
{
    public class OutfitsController : Controller
    {
        ...
        {
            var outfits = db.Outfits.Include(o => o.Outfit2).Include(o => o.Accessory).Include(o => o.Bottom).Include(o => o.Sho).Include(o => o.Top);
        ...
        {
            ViewBag.AccessoriesID = new SelectList(db.Outfits, "OufitID", "Name");
        ...
        public ActionResult Create([Bind(Include = "OufitID,Name,TopsID,BottomsID,ShoesID,AccessoriesID,Occasion,Photo")] Outfit outfit)
        {
            ...
            ViewBag.AccessoriesID = new SelectList(db.Outfits, "OufitID", "Name", outfit.AccessoriesID);
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public ActionResult Edit([Bind(Include = "OufitID,Name,TopsID,BottomsID,ShoesID,AccessoriesID,Occasion,Photo")] Outfit outfit)
        {
            if (ModelState.IsValid)
            {
