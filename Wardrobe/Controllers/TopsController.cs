...
namespace Wardrobe.Controllers
{
    public class TopsController : Controller
    {
        ...
        public ActionResult Create([Bind(Include = "TopsID,Name,Color,Season,Occasion,Photo")] Top top)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public ActionResult Edit([Bind(Include = "TopsID,Name,Color,Season,Occasion,Photo")] Top top)
        {
            if (ModelState.IsValid)
            {
